...
export default function App() {
  ...
  return (
    <div className="w-screen min-h-screen bg-slate-950 text-slate-100 p-5 font-sans pb-10">
      ...
      {(autoSave || autoLoad) && (
        <div className="flex items-start gap-2.5 mt-3 p-3 bg-amber-500/5 border border-amber-500/20 rounded-xl backdrop-blur-sm animate-fadeIn">
          ...
          <div className="flex flex-col">
            <span className="text-xs font-semibold text-amber-400">Recomendación de Uso</span>
            <span className="text-[11px] text-slate-400 leading-normal mt-0.5">
              Se recomienda mantener estas funciones activas <b>solo durante el llenado de formularios</b> para evitar sobreescribir datos accidentalmente.
            </span>
          </div>
        </div>
      )}
